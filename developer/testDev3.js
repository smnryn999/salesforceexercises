...
const test = ["In Apex, what is the purpose of a constructor method in a class?",
              ...
              "Which of the following code snippets correctly defines a column in a lightning-datatable component in a Lightning Web Component (LWC)?", 'In Aura Components, what is the purpose of the "controller" object exemplified above in the component bundle?'];
...
const options1 = [["To define the layout of user interface elements.","To create an instance of an object from a class.","To establish a connection to external APIs.","To handle exceptions and errors in the code."],
                 ...
                 ["To define the component's visual layout and structure.","To handle client-side logic and user interactions.","To specify the component's styling and CSS rules.","To manage server-side data retrieval and manipulation."]];
const answers = [B,A,A,A,D,C,C,B,A,C,D,A,B];
