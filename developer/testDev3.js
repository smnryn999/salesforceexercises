...
const test = ["In Apex, what is the purpose of a constructor method in a class?",
              ...
              "Which HTTP Status Code is returned after the POST request is successful?", "How can we switch to master branch in Git local repository?",
...
const options1 = [["To define the layout of user interface elements.","To create an instance of an object from a class.","To establish a connection to external APIs.","To handle exceptions and errors in the code."],
                 ...
                 ["To define the component's visual layout and structure.","To handle client-side logic and user interactions.","To specify the component's styling and CSS rules.","To manage server-side data retrieval and manipulation."], [200,201,400,401], ["git master","git branch master","git checkout master","git switch master"],
...
const answers = [B,A,A,A,D,C,C,B,A,C,D,A,B,B,C,D,B];
