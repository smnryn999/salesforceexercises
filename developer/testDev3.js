...
const test = ["In Apex, what is the purpose of a constructor method in a class?",
              ...
              "Which of the following code snippets correctly defines a column in a lightning-datatable component in a Lightning Web Component (LWC)?"];
...
const answers = [B,A,A,A,D,C,C,B,A,C,D,A];
