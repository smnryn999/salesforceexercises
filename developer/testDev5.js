...
const test = ["integration and LWC, LMS?", "In a company called Página Blanca Sales Inc., Rose, Salesforce Developer, need to update 500 thousands opportunity records. Which code snippet should she use?", "Which of the following is true?", "In a Lightning Web Component (LWC) parent-child relationship, what is the purpose of the @api decorator in the child component?",
             ...
             'In an Apex class, "this" keyword cannot be referenced in a static context. True or false?', "How can you send a message from one Lightning Web Component (LWC) to another using the Lightning Message Service (LMS)?"]; 
const options1 = [["","","",""],
                  ...
                  ["Directly invoke the methods and properties of the target LWC from the source LWC.","Include a hidden input field in the HTML and update its value to send messages.","Use the window.postMessage() function to communicate between LWCs.","Import the LMS module and use the LMS.publish() method to send a message."]];
const answers = [A,A,B,C,C,D,B,A,C,A,B,A,D,C,B,B,A,D];
