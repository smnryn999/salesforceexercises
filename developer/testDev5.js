...
const options1 = [["","","",""],
                  ...
                  ["<code>List&lt;String&gt; names = ['Alice', 'Bob', 'Charlie'];</code>","<code>List&lt;String&gt; names = new List&lt;String&gt;{'Alice', 'Bob', 'Charlie'};</code>","<code>List&lt;String&gt; names = new List('Alice', 'Bob', 'Charlie');</code>","<code>List&lt;String&gt; names;<br> names.add('Alice');<br> names.add('Bob');<br> names.add('Charlie');</code>"]];
const answers = [A,A,B,C,C,D,B,A,C,A,B];
