...
const test = ["Which of the following is true for Apex?", "<code>String str = 'hello world'; <br> String str2 = str.capitalize(); <br> System.debug(str2);</code> <br> What is the output of the code snippet above?",
              ...
              "What is one of the advantages of using Lightning Web Components (LWC) over Aura components?"];
...
pass.onclick = function () {
  ...
  for(var i=0; i<codes.length; i++){
     ...
     var datatypes = ["String", " Date ", "Integer", "Boolean", "Decimal", "override", "virtual", "static","void","class", "LightningElement", "lwc", "Text", "trigger", "interface", "Http", "HttpRequest", "HttpResponse"];
