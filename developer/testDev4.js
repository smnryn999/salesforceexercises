...
const options1 = [["Apex is a strongly typed, object-oriented programming language.","Apex uses syntax that looks like Java.","Apex enables developers to add business logic to most system events.","All of above."],
                  ...
                  ["<code>public class ExternalServiceIntegration { <br> &nbsp; public String getExternalData() { <br> &nbsp; &nbsp; Http http = new Http(); <br> &nbsp; &nbsp; HttpRequest request = new HttpRequest(); <br> &nbsp; &nbsp; request.setEndpoint('https://api.example.com/data'); <br> &nbsp; &nbsp; request.setMethod('POST'); <br> &nbsp; &nbsp; HttpResponse response = http.send(request); <br> &nbsp; &nbsp; if (response.getStatusCode() == 200) { <br> &nbsp; &nbsp;&nbsp; return response.getBody(); <br> &nbsp; &nbsp; } <br> &nbsp; &nbsp; return 'No Response'; <br> &nbsp; } <br> }</code>",
                   "<code>public class ExternalServiceIntegration { <br> &nbsp; public String getExternalData() { <br> &nbsp; &nbsp; Http http = new Http(); <br> &nbsp; &nbsp; HttpRequest request = new HttpRequest(); <br> &nbsp; &nbsp; request.setEndpoint('https://api.example.com/data'); <br> &nbsp; &nbsp; request.setMethod('TAKE'); <br> &nbsp; &nbsp; HttpResponse response = http.send(request); <br> &nbsp; &nbsp; if (response.getStatusCode() == 200) { <br> &nbsp; &nbsp;&nbsp; return response.getBody(); <br> &nbsp; &nbsp; } <br> &nbsp; &nbsp; return 'No Response'; <br> &nbsp; } <br> }</code>",
                   ...
                   "<code>public class ExternalServiceIntegration { <br> &nbsp; public String getExternalData() { <br> &nbsp; &nbsp; Http http = new Http(); <br> &nbsp; &nbsp; HttpRequest request = new HttpRequest(); <br> &nbsp; &nbsp; request.setEndpoint('https://api.example.com/data'); <br> &nbsp; &nbsp; request.setMethod('POST'); <br> &nbsp; &nbsp; HttpResponse response = http.send(request); <br> &nbsp; &nbsp; if (response.getStatusCode() == 200) { <br> &nbsp; &nbsp;&nbsp; return response.getBody(); <br> &nbsp; &nbsp; } <br> &nbsp; &nbsp; return 'No Response'; <br> &nbsp; } <br> }</code>"]];
const answers = [D,B,B,C,C,A,D,A,A,D,D,B,C];
