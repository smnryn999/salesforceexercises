...
const test = ["Which of the following is true for Apex?", "<code>String str = 'hello world'; <br> String str2 = str.capitalize(); <br> System.debug(str2);</code> <br> What is the output of the code snippet above?",
              ...
              "<code>List&ltUser&gt users = [SELECT Id, FIELDS(ALL) FROM User LIMIT 200]; <br> System.debug(users); </code> <br> What is the output of the code snippet above?", "Which of the following is one of the purposes of using Asynchronous Apex?",
              ...
              "What is one of the advantages of using Lightning Web Components (LWC) over Aura components?", "Which of the following lightning buttons triggers the handleClick function when clicked?",
              ...
              "Which of the followings is false?", "Which method of a Batch class is responsible for processing a batch of records?", "Which event should we use when we want to send a custom notification automatically when some lead records are updated?", "In a Lightning Web Component (LWC), what is the correct way to import an Apex method?"];
...
const options1 = [["Apex is a strongly typed, object-oriented programming language.","Apex uses syntax that looks like Java.","Apex enables developers to add business logic to most system events.","All of above."],
                  ...
                  ["start()","execute()","finish()","process()"], ["before insert","after insert","before update","after update"], ['import myMethod from "MyClass.myMethod()";','import {myMethod} from "@AuraEnabled/apex/MyClass.myMethod";','import myMethod from "@salesforce/apex/MyClass.myMethod";','import {myMethod} from "@salesforce/apex/MyClass.myMethod()";']];
const answers = [D,B,B,C,C,A,D,A,A,D,D,B,C,B,A,C,D,B,D,C];
