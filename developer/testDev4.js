...
const test = ["Which of the following is true for Apex?", "<code>String str = 'hello world'; <br> String str2 = str.capitalize(); <br> System.debug(str2);</code> <br> What is the output of the code snippet above?",
              ...
              "<code>try { <br> &nbsp; List<Integer> numbers = new List<Integer>(); <br> &nbsp; li.add(15); <br> &nbsp; Integer num1 = numbers[0]; <br> &nbsp; Integer num2 = numbers[1]; <br>}<br> catch(Exception e) { <br> &nbsp; System.debug('The following exception has occurred: ' + e.getMessage()); <br> }</code> <br><br> What exception type does the code snippet above cause?"];
...
const options1 = [["Apex is a strongly typed, object-oriented programming language.","Apex uses syntax that looks like Java.","Apex enables developers to add business logic to most system events.","All of above."],
                  ...
                  ["QueryException","SObjectException","ListException","NullPointerException"]];
const answers = [D,B,B,C,C,A,D,A,A,D,D,B,C,B,A,C];
