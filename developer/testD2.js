...
const test = ['Which of the following Visualforce code snippets correctly creates a command button that calls the "updateRecord" method in the controller when clicked?', 'What does the "trigger.new" keyword refer to in Salesforce Apex triggers?',
             ...
             "Which of the following is the correct syntax for creating a new Apex class?", "Which of the following is the correct way to create a new Map in Apex?", "<code>public class ContactController { <br> public static List<Contact> getContacts(Id accId){ <br> return [SELECT Name  FROM Contact WHERE AccountId = :accId]; <br> }<br>}</code> <br> This Apex method takes the current record's Id as a parameter and returns the related contacts."];
