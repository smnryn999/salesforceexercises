...
const options1 = [['<code>&lt;apex:commandButton action="{!updateRecord}" value="Update"/&gt;</code>','<code>&lt;apex:commandButton method="updateRecord" value="Update"/&gt;</code>','<code>&lt;apex:commandButton onclick="{!updateRecord}" value="Update"/&gt;</code>','<code>&lt;apex:commandButton actionName="updateRecord" value="Update"/&gt;</code>'],
                 ...
                 ['<code>import { LightningElement, wire } from "lwc"; <br> import listContact from "@salesforce/apex/ContactController.listContact"; <br><br> export default class ApexWireMethod extends LightningElement {<br> <samp>@api recordId;</samp> <br> <samp>@wire(listContact, { recordId: "$recordId"}) contacts;</samp> <br> }</code>',"","",
                  '<code>import { LightningElement, api, wire } from "lwc"; <br> import listContact from "@salesforce/apex/ContactController.listContact"; <br><br> export default class ApexWireMethod extends LightningElement {<br> <samp>@api recordId;</samp> <br> <samp>@wire(listContact, { recordId: "$recordId"}) contacts;</samp> <br> }</code>']];
