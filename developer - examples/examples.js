...
var showButtons = document.querySelectorAll(".showSolution");
   ...
   for(var i=0; i<pres.length; i++){
     ...
     // content = content.replaceAll(/Set<string>/gi, "<span class='datatype'>Set&#60;String&#62;</span>");
      ...
      // key
      var keys = [" class ", " trigger ", "System.debug", "System.assertEquals", "System.assert", "if ", "else if", "else ", "console.log"];
       for(k of keys){
      ...
      var datatypes = ["String ", " Date ", "Integer", "Boolean", "Decimal ", "Datetime", "AggregateResult", "override", "virtual", "abstract", "List&lt;String&gt;",
		       ...
		       "List&lt;List&lt;SObject&gt;&gt;", "List&lt;SObject&gt;", "SObject", "Object ", "const ", "var ", "let ", "Movies__c", "Series__c", "Book__c"]; 
      for(d of datatypes){
