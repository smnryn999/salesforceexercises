...
var showButtons = document.querySelectorAll(".showSolution");
   ...
   for(var i=0; i<pres.length; i++){
     ...
     // content = content.replaceAll(/boolean/gi, "<span class='datatype'>Boolean</span>");
      ...
      var datatypes = ["String", " Date ", "Integer", "Boolean", "Decimal", "Datetime", "Double", "override", "virtual", "abstract", "List&lt;Account&gt;", "List&lt;Book__c&gt;", "List&lt;Opportunity&gt;"]; 
      for(d of datatypes){
      ...
      var soql = ["SELECT", "FROM", "WHERE", "LIMIT", "IN", "NOT", "AND", "HAVING", "LIKE", "ORDER BY", "DESC", "NULLS LAST", "insert"];
      for(s of soql){
