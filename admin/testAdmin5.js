...
const test = ["Which of the following is used to set highlights panel?", "What is the purpose of Escalation Rules?", "Which of the following is not a dashboard component type?",
              ...
              "If we want to send an email with Flow, which element should we use?", 'In a typical Approval Process, what is the purpose of the "final approval action"?', "Which of the following is not one of the summarize calculations in Reports?"];
...
const options1 = [["Compact Layout","Page Layout","Search Layout","List View Layout"],
                  ...
                  ["To reject the record if it doesn't meet approval criteria.","To define what happens after the record has been approved.","To specify the initial approver for the record.","To automatically submit the record for approval."], ["Count","Sum","Avg","Median"]];
