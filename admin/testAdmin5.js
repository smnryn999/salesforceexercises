...
const options1 = [["Compact Layout","Page Layout","Search Layout","List View Layout"],
                  ...
                  ["CSV","TXT","XML","DOCX"], ["Phone","Text Area","Multi-select Picklist","Rich Text Area"], ["LINK()","HYPERLINK()","FIND()","SEARCH()"], ["Customer Relationship Management","Inventory Management","Configure complex product offerings and pricing","Social Media Marketing and Advertising"]];
const answers = [A,B,D,B,C,D,C,A,A,B,C];
