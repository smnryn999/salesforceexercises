...
const test = ["What is Salesforce?", "What is CRM (Customer Relationship Management)?", "What is a cloud-based system?", "If we cannot delete a field, what could be the reason?", "If we want to make a field required universally and only for some profiles, how do we do it?",
              "Which field type cannot be used as External ID?"];
