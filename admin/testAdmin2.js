...
const test1 = ["What type of relationship in Salesforce represents a parent-child relationship, where the child record can't exist without the parent and inherits its sharing and security settings?", "In Salesforce, what are Record Types used for?",
               ...
               "It is mandatory to enter an entry criteria in the approval process. True or false?","As an admin, we need to import 20 thousand records for custom Book_c object. What tool can we use for this?",
               "We want to create a Validation Rule that gives an error if the website field is empty while creating an Account record. Which of the following provides this?"];
...
const answers1 = [B,D,D,A,C,A,B,D,C,A,C,C,A,B,D,B];
