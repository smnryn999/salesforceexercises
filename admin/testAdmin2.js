...
const options1 = [["Lookup Relationship","Master-Detail Relationship","External Relationship","Hierarchical Relationship"], ["Providing quality data.","Ensuring that relevant data are entered for each record.","Providing different sets of picklist values for a field.","All of above."],
                  ...
                  ["Custom metadata types can be used to create custom fields on standard objects.","Custom metadata types can be used to define record-level security.","Custom metadata types can be used to build apps that are defined our own frameworks.","Custom metadata types support data import and export through the data loader."],
