...
const test = ["What is the purpose of a search layout?", "How are many-to-many relationships implemented in Salesforce?", "How many fields can be assigned to a compact layout?", "What is the primary purpose of a Salesforce Dashboard?",
              ...
              "In a fictional company called CloudTech Solutions, there's a process for employee onboarding. To streamline this process, the HR department uses Salesforce Flow. <br><br> When a new employee joins, what can the HR team use Flow for?"];
