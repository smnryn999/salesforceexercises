...
const test = ["What is the purpose of a search layout?", "How are many-to-many relationships implemented in Salesforce?", "How many fields can be assigned to a compact layout?", "What is the primary purpose of a Salesforce Dashboard?",
              ...
              "In a fictional company called CloudTech Solutions, there's a process for employee onboarding. To streamline this process, the HR department uses Salesforce Flow. <br><br> When a new employee joins, what can the HR team use Salesforce Flow for?"];
...
const options1 = [["To customize the layout of record detail pages.","To manage user permissions and access.","To define the layout of dashboard components.","To define the fields displayed in search results."],
                 ...
                 ["Creating a new email account for the employee","Generating performance reports for existing employees","Ordering office supplies","Sending welcome messages to the employee's team"]];
const answers = [D,B,D,C,A,B,D,C,A,A,B,C,A,C,B,D,B,D];
