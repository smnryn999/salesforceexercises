...
const options1 = [["To customize the layout of record detail pages.","To manage user permissions and access.","To define the layout of dashboard components.","To define the fields displayed in search results."],
                 ...
                 ["To create custom objects in Salesforce.","To define validation rules for record fields.","To perform quick actions from anywhere, such as creating records or sending emails.","To manage user access and permissions in Salesforce."]];
const answers = [D,B,D,C,A,B,D,C,A,A,B,C,A,C];
